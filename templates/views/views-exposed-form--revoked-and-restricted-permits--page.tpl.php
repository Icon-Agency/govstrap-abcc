...
<div class="view-filters">
    <div class="views-exposed-form">
        <div class="views-exposed-widgets clearfix">
          <?php if (isset($widgets['sort-sort_bef_combine'])) : ?>
              <h3 class="text-uppercase h5 font-family3 theme-color safe small bold">Sort by</h3>
              <div id="<?php print $widgets['sort-sort_bef_combine']->id; ?>-wrapper"
                   class="views-exposed-widget views-widget-<?php print $widgets['sort-sort_bef_combine']->id; ?>">
                  <div class="views-widget">
                    <?php print $widgets['sort-sort_bef_combine']->widget; ?>
                  </div>
              </div>
            <?php unset($widgets['sort-sort_bef_combine']); ?>
          <?php endif; ?>
