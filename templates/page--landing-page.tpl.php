    ...
    <div class="mm-content">
      ...
      <?php include 'includes/page-header.tpl.php'; ?>
        ...
        <div class="banner slim-line bg-dark-blue text-white theme-color-gradient-after">
            <div class="bg-img"
                 style="background-size: contain; background-position-x: 100%; background-image: url(/<?php print path_to_theme(); ?>/images/banners/ABCC-Banner-0<?php print rand(1, 13);?>.png)">
                <div class="container">
                    <div class="row">
