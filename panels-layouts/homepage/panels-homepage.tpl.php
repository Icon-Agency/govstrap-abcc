                            ...
                            <div class="accent color-green">
                              ...
                              ?>
                                <?php if ($book_latest_industry_update): ?>
                                    <span class="font-family3 text-uppercase small"><strong class="text-green">Issue </strong> — <?php print $latest_industry_update['title']; ?></span>
                                    <h2 class="h1 text-green mb-4">Industry update <i class="fal fa-arrow-circle-right fa-xs ml-1"></i></h2>
                                    <ul class="list-unstyled fixed-number-list font-family3 color-white large">
                                        <?php
                                          ...
                                          <?php $chapter_index++; ?>
                                            <li class="mb-1"><span class="icon text-green"><?php print $chapter_prefix.$chapter_index; ?>.</span>
                                                <?php print l($book_latest_industry_update_chapter["link"]["title"], $book_latest_industry_update_chapter["link"]["link_path"]); ?>
                                            </li>
                                          <?php endforeach; ?>
                                    </ul>
                                <?php endif; ?>
                                <?php print print $content['row-3']; ?>
                            </div>
                        </div>
                    </div>
                </div>
